		      ...
		      ?>
		         <script type="text/javascript">
		              function datahum_gauge(){
		                <?php 
		                    $sqlpush = "SELECT sunshine FROM greenhouse ORDER BY id DESC LIMIT 1";
...
<!-- AWAL SUNSHINE RADIAL GAUGE -->
		<script type="text/javascript">
	      ...
	      function load_datahum_radial(){
	        $("#update-radialhum-gauge").load("load-update-radialsunshine-gauge.php", {
      ...
      var config = {
        ...
        data: {
          ...
          datasets: [
            {
              data: [datahum_gauge()],
              backgroundColor: '#FFC107',    //gradiiennt stroke '[gradientStroke]' tidak dipakai
              borderWidth: 0,
              label: 'Score'
            }
          ]
